...
// F32 synthetic llama32 graph on WGPU (skips when no adapter).
...
mod wgpu_tests {
    ...
    #[test]
    fn llama32_tiny_graph_runs_on_wgpu() {
        ...
        let mut compiled =
            super::compile_support::compile_llama32_prefill(Device::Gpu, graph, params.clone());
