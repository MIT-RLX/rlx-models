...
// F32 synthetic llama32 graph on CUDA (skips when no driver).
...
mod cuda_tests {
    ...
    #[test]
    fn llama32_tiny_graph_runs_on_cuda() {
        ...
        let mut compiled =
            super::compile_support::compile_llama32_prefill(Device::Cuda, graph, params.clone());
