...
//! NVFP4 `x_embedder` DequantMatMul on CUDA (synthetic packed weights).

#[cfg(feature = "cuda")]
use rlx_models::flux2::{
    Flux2Config, compile_flux2_forward, host_temb, synthetic_flux2_packed_tiny, synthetic_weights,
};
#[cfg(feature = "cuda")]
...
#[cfg(feature = "cuda")]
#[test]
fn nvfp4_x_embedder_runs_on_cuda() {
