...
//! Audio I/O helpers for wake-word (16 kHz mono f32).
...
/// Write mono f32 PCM as 16-bit WAV (for  corpora / demos).
pub fn write_wav_mono_f32(path: &Path, sample_rate: u32, pcm: &[f32]) -> Result<()> {
