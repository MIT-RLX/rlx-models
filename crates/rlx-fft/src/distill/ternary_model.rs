...
use crate::spectral::mel::{
    hann_window, log_mel_from_spectrum_batch, mel_filterbank, ref_log_mel_batch,
};
use crate::spectral::welch::{WelchParams, average_welch_psd, welch_windowed_segments};
...
impl DistilledTernaryFftModel {
    pub fn new(n_fft: usize, n_mels: usize, sample_rate: f32) -> Self {
        ...
        Self {
            ...
            denoiser: SpectrumCorrection::from_kind(
                crate::distill::ternary_arch::CorrectorKind::BandWide,
                n_fft,
                false,
            ),
    ...
    pub fn welch_psd_batch(
        ...
        let window = crate::spectral::welch::hann_window(self.n_fft);
    ...
    pub fn welch_peaks_batch(
        ...
        signal: &[f32],
        batch: usize,
        params: crate::spectral::peak::WelchPeakParams,
    ) -> Result<Vec<f32>> {
        ...
        let spec = self.denoiser.apply_batch(&spec, n_segs, self.n_fft)?;
        Ok(crate::spectral::peak::welch_peaks_from_segment_spectrum(
            &spec, batch, params,
        ))
    }
    ...
    pub fn train_step_mel(
        ...
        let grad = crate::spectral::mel::log_mel_loss_grad_wrt_spectrum(
            &pred,
            target_mel,
            &spec,
            &self.mel_filters,
...
mod tests {
    ...
    fn prune_band_corrector_accepts_skips() {
        ...
        let teacher_mel = crate::distill::model::teacher_mel_batch(&teacher, &signal, 8).unwrap();
