...
use crate::spectral::welch_peaks_compile::build_welch_peaks_fused_graph;
...
pub fn welch_peaks_fusion_target(device: Device) -> rlx_compile::FusionTarget {
    ...
    match device {
        ...
        Device::Cpu | Device::Hexagon | Device::Xdna | Device::Egpu => FusionTarget::Cpu,
    }
}
    ...
    fn print_cuda_fused_cost_breakdown() {
        ...
        for batch in [256usize, 8192] {
            ...
            eprintln!(
                ...
                crate::spectral::welch_peaks_cost::fused_io_compute_scale_for_calibration(
                    Device::Cuda
                ),
                costs.fast_ns / 1e6,
                fused / 1e6,
                ...
                bd.should_fuse,
                costs.rlx_ns / 1e6,
                crate::spectral::welch_peaks_picker::pick_welch_peaks_strategy(
                    Device::Cuda,
                    batch,
                    256,
                    16,
