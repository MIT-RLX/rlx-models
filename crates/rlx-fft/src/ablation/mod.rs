...
//!
//! Submodules: CSV / JSON / HTML report writers and the ternary ablation.

pub mod csv;
pub mod html;
pub mod ternary;
pub mod ternary_html;

use crate::bench::sweep::available_devices;
use crate::exec::device::resolve_train_device;
use crate::exec::rlx_fft::interleaved_to_block;
...
use crate::study::telemetry::variant_param_breakdown;
